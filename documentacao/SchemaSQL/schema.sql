...
--
-- Name: aluno unique_email; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: aluno aluno_email_key; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.aluno
    ADD CONSTRAINT aluno_email_key FOREIGN KEY (email) REFERENCES public.usuario(email);
