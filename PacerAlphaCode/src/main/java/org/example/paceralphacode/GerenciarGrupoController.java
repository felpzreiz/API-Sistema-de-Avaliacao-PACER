...
public class GerenciarGrupoController {
    ...
    void adicionargrupo(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(ExecuteApplication.class.getResource("DefinirNomeGrupo.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        dialog.setTitle("Defina o nome do Grupo");
        dialog.setScene(scene);

        DefinirNomeGrupoController cadastroGrupoController = fxmlLoader.getController();
