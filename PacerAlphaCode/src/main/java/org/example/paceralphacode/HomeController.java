...
public class HomeController {
    ...
    void pageAlunos(ActionEvent event) throws IOException {                                                                       //  Método pageAlunos() Abre a interface a direita da pagina correspondente
        ...
        Parent gAlunos = FXMLLoader.load(getClass().getResource("GerenciarAluno.fxml"));    // Parent é uma Classe para organizar as estruturas graficas. Aqui ele obtem a AnchorPane gAlunos que se encontra no arquivo fxml
    ...
    void pageGroup(ActionEvent event) throws IOException {
        ...
        Parent gGroup = FXMLLoader.load(getClass().getResource("GerenciarGrupo.fxml"));
    ...
    void pageHome(ActionEvent event) throws IOException {                                                                //  Para voltar a pagina Home devido ser uma SplitPane é preciso obter os dados da pagina inteira
        ...
        Parent Pacer = FXMLLoader.load(getClass().getResource("Home.fxml"));                 //  Instancia a ordem gráfica e obtem a home.fxml que é a pagina inicial
    ...
    void pageSprint(ActionEvent event) throws IOException {
        Homepage.getChildren().clear();
        Parent gSprints = FXMLLoader.load(getClass().getResource("GerenciarSprint.fxml"));
